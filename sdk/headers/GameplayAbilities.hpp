...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
    ...
    FPredictionKey PredictionKey;                                                     // 0x0018 (size: 0x18)
    FGameplayCueParameters Parameters;                                                // 0x0030 (size: 0xD8)
    bool bPredictivelyRemoved;                                                        // 0x0108 (size: 0x1)
...
struct FActiveGameplayEffect : public FFastArraySerializerItem
{
    ...
    FPredictionKey PredictionKey;                                                     // 0x02B0 (size: 0x18)
    TArray<FGameplayAbilitySpecHandle> GrantedAbilityHandles;                         // 0x02C8 (size: 0x10)
    float StartServerWorldTime;                                                       // 0x02D8 (size: 0x4)
    float CachedStartServerWorldTime;                                                 // 0x02DC (size: 0x4)
    float StartWorldTime;                                                             // 0x02E0 (size: 0x4)
    bool bIsInhibited;                                                                // 0x02E4 (size: 0x1)
...
struct FGameplayAbilityActivationInfo
{
    ...
    FPredictionKey PredictionKeyWhenActivated;                                        // 0x0008 (size: 0x18)
...
struct FGameplayAbilityLocalAnimMontage
{
    ...
    FPredictionKey PredictionKey;                                                     // 0x0010 (size: 0x18)
    TWeakObjectPtr<class UGameplayAbility> AnimatingAbility;                          // 0x0028 (size: 0x8)
...
struct FGameplayAbilityRepAnimMontage
{
    ...
    uint8 PlayInstanceId;                                                             // 0x0015 (size: 0x1)
    uint8 bRepPosition;                                                               // 0x0016 (size: 0x1)
    uint8 IsStopped;                                                                  // 0x0016 (size: 0x1)
    uint8 SkipPositionCorrection;                                                     // 0x0016 (size: 0x1)
    uint8 bSkipPlayRate;                                                              // 0x0016 (size: 0x1)
    FPredictionKey PredictionKey;                                                     // 0x0018 (size: 0x18)
    uint8 SectionIdToPlay;                                                            // 0x0030 (size: 0x1)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
    ...
    FGameplayAbilityActivationInfo ActivationInfo;                                    // 0x0040 (size: 0x20)
    FGameplayTagContainer DynamicAbilityTags;                                         // 0x0060 (size: 0x20)
    TArray<class UGameplayAbility*> NonReplicatedInstances;                           // 0x0080 (size: 0x10)
    TArray<class UGameplayAbility*> ReplicatedInstances;                              // 0x0090 (size: 0x10)
    FActiveGameplayEffectHandle GameplayEffectHandle;                                 // 0x00A0 (size: 0x8)
...
{
    FGameplayAbilityTargetingLocationInfo SourceLocation;                             // 0x0010 (size: 0xA0)
    TArray<TWeakObjectPtr<AActor>> TargetActorArray;                                  // 0x00B0 (size: 0x10)
...
{
    FGameplayAbilityTargetingLocationInfo SourceLocation;                             // 0x0010 (size: 0xA0)
    FGameplayAbilityTargetingLocationInfo TargetLocation;                             // 0x00B0 (size: 0xA0)

}; // Size: 0x150

struct FGameplayAbilityTargetData_SingleTargetHit : public FGameplayAbilityTargetData
{
    FHitResult HitResult;                                                             // 0x0008 (size: 0xE8)
    bool bHitReplaced;                                                                // 0x00F0 (size: 0x1)
...
struct FGameplayAbilityTargetingLocationInfo
{
    ...
    class AActor* SourceActor;                                                        // 0x0080 (size: 0x8)
    class UMeshComponent* SourceComponent;                                            // 0x0088 (size: 0x8)
    class UGameplayAbility* SourceAbility;                                            // 0x0090 (size: 0x8)
    FName SourceSocketName;                                                           // 0x0098 (size: 0x8)
...
{
    FPredictionKey PredictionKey;                                                     // 0x0018 (size: 0x18)
    EGameplayCuePayloadType PayloadType;                                              // 0x0030 (size: 0x1)
    class UAbilitySystemComponent* OwningComponent;                                   // 0x0038 (size: 0x8)
    FGameplayEffectSpecForRPC FromSpec;                                               // 0x0040 (size: 0x78)
    FGameplayCueParameters CueParameters;                                             // 0x00B8 (size: 0xD8)
...
{
    TMap<UClass*, class FGameplayCueNotifyActorArray> PreallocatedInstances;          // 0x0000 (size: 0x50)
...
struct FServerAbilityRPCBatch
{
    ...
    FPredictionKey PredictionKey;                                                     // 0x0008 (size: 0x18)
    FGameplayAbilityTargetDataHandle TargetData;                                      // 0x0020 (size: 0x28)
    bool InputPressed;                                                                // 0x0048 (size: 0x1)
    bool Ended;                                                                       // 0x0049 (size: 0x1)
    bool Started;                                                                     // 0x004A (size: 0x1)
...
{
    class UAbilitySystemComponent* AbilitySystemComponent;                            // 0x0360 (size: 0x8)

}; // Size: 0x368

class AGameplayAbilityTargetActor : public AActor
{
    bool ShouldProduceTargetDataOnServer;                                             // 0x0298 (size: 0x1)
    FGameplayAbilityTargetingLocationInfo StartLocation;                              // 0x02A0 (size: 0xA0)
...
{
    FWorldReticleParameters Parameters;                                               // 0x0298 (size: 0x18)
    bool bFaceOwnerFlat;                                                              // 0x02B0 (size: 0x1)
    bool bSnapToTargetedActor;                                                        // 0x02B1 (size: 0x1)
    bool bIsTargetValid;                                                              // 0x02B2 (size: 0x1)
    bool bIsTargetAnActor;                                                            // 0x02B3 (size: 0x1)
    class APlayerController* PrimaryPC;                                               // 0x02B8 (size: 0x8)
    class AGameplayAbilityTargetActor* TargetingActor;                                // 0x02C0 (size: 0x8)
...
{
    class UCapsuleComponent* CollisionComponent;                                      // 0x02C8 (size: 0x8)
    TArray<class UActorComponent*> VisualizationComponents;                           // 0x02D0 (size: 0x10)

}; // Size: 0x2E0

class AGameplayCueNotify_Actor : public AActor
{
    bool bAutoDestroyOnRemove;                                                        // 0x0298 (size: 0x1)
    float AutoDestroyDelay;                                                           // 0x029C (size: 0x4)
    bool WarnIfTimelineIsStillRunning;                                                // 0x02A0 (size: 0x1)
    bool WarnIfLatentActionIsStillRunning;                                            // 0x02A1 (size: 0x1)
    FGameplayTag GameplayCueTag;                                                      // 0x02A4 (size: 0x8)
    FName GameplayCueName;                                                            // 0x02AC (size: 0x8)
    bool bAutoAttachToOwner;                                                          // 0x02B4 (size: 0x1)
    bool IsOverride;                                                                  // 0x02B5 (size: 0x1)
    bool bUniqueInstancePerInstigator;                                                // 0x02B6 (size: 0x1)
    bool bUniqueInstancePerSourceObject;                                              // 0x02B7 (size: 0x1)
    bool bAllowMultipleOnActiveEvents;                                                // 0x02B8 (size: 0x1)
    bool bAllowMultipleWhileActiveEvents;                                             // 0x02B9 (size: 0x1)
    int32 NumPreallocatedInstances;                                                   // 0x02BC (size: 0x4)
...
{
    FGameplayCueNotify_SpawnCondition DefaultSpawnCondition;                          // 0x0308 (size: 0x38)
    FGameplayCueNotify_PlacementInfo DefaultPlacementInfo;                            // 0x0340 (size: 0x40)
    FGameplayCueNotify_BurstEffects BurstEffects;                                     // 0x0380 (size: 0x298)
    FGameplayCueNotify_SpawnResult BurstSpawnResults;                                 // 0x0618 (size: 0x58)
...
class AGameplayCueNotify_Looping : public AGameplayCueNotify_Actor
{
    FGameplayCueNotify_SpawnCondition DefaultSpawnCondition;                          // 0x0308 (size: 0x38)
    FGameplayCueNotify_PlacementInfo DefaultPlacementInfo;                            // 0x0340 (size: 0x40)
    FGameplayCueNotify_BurstEffects ApplicationEffects;                               // 0x0380 (size: 0x298)
    FGameplayCueNotify_SpawnResult ApplicationSpawnResults;                           // 0x0618 (size: 0x58)
    FGameplayCueNotify_LoopingEffects LoopingEffects;                                 // 0x0670 (size: 0x1F0)
    FGameplayCueNotify_SpawnResult LoopingSpawnResults;                               // 0x0860 (size: 0x58)
    FGameplayCueNotify_BurstEffects RecurringEffects;                                 // 0x08B8 (size: 0x298)
    FGameplayCueNotify_SpawnResult RecurringSpawnResults;                             // 0x0B50 (size: 0x58)
    FGameplayCueNotify_BurstEffects RemovalEffects;                                   // 0x0BA8 (size: 0x298)
    FGameplayCueNotify_SpawnResult RemovalSpawnResults;                               // 0x0E40 (size: 0x58)
...
class UAbilitySystemComponent : public UGameplayTasksComponent
{
    ...
    bool UserAbilityActivationInhibited;                                              // 0x0398 (size: 0x1)
    bool ReplicationProxyEnabled;                                                     // 0x0399 (size: 0x1)
    bool bSuppressGrantAbility;                                                       // 0x039A (size: 0x1)
    bool bSuppressGameplayCues;                                                       // 0x039B (size: 0x1)
    TArray<class AGameplayAbilityTargetActor*> SpawnedTargetActors;                   // 0x03A0 (size: 0x10)
    class AActor* OwnerActor;                                                         // 0x03D8 (size: 0x8)
    class AActor* AvatarActor;                                                        // 0x03E0 (size: 0x8)
    FGameplayAbilitySpecContainer ActivatableAbilities;                               // 0x03F8 (size: 0x120)
    TArray<class UGameplayAbility*> AllReplicatedInstancedAbilities;                  // 0x0548 (size: 0x10)
    FGameplayAbilityRepAnimMontage RepAnimMontageInfo;                                // 0x0788 (size: 0x38)
    bool bCachedIsNetSimulated;                                                       // 0x07C0 (size: 0x1)
    bool bPendingMontageRep;                                                          // 0x07C1 (size: 0x1)
    FGameplayAbilityLocalAnimMontage LocalAnimMontageInfo;                            // 0x07C8 (size: 0x30)
    FActiveGameplayEffectsContainer ActiveGameplayEffects;                            // 0x0898 (size: 0x2F8)
    FActiveGameplayCueContainer ActiveGameplayCues;                                   // 0x0B90 (size: 0x128)
    FActiveGameplayCueContainer MinimalReplicationGameplayCues;                       // 0x0CB8 (size: 0x128)
    TArray<uint8> BlockedAbilityBindings;                                             // 0x0F08 (size: 0x10)
    FMinimalReplicationTagCountMap MinimalReplicationTags;                            // 0x1040 (size: 0x60)
    TArray<class UAttributeSet*> SpawnedAttributes;                                   // 0x10A0 (size: 0x10)
    FMinimalReplicationTagCountMap ReplicatedLooseTags;                               // 0x10C0 (size: 0x60)
    FReplicatedPredictionKeyMap ReplicatedPredictionKeyMap;                           // 0x1128 (size: 0x118)
...
class UAbilitySystemGlobals : public UObject
{
    ...
    bool bUseDebugTargetFromHud;                                                      // 0x0070 (size: 0x1)
...
class UAbilityTask_ApplyRootMotionMoveToActorForce : public UAbilityTask_ApplyRootMotion_Base
{
    ...
    FVector TargetLocationOffset;                                                     // 0x0118 (size: 0x18)
    ERootMotionMoveToActorTargetOffsetType OffsetAlignment;                           // 0x0130 (size: 0x1)
    float Duration;                                                                   // 0x0134 (size: 0x4)
    bool bDisableDestinationReachedInterrupt;                                         // 0x0138 (size: 0x1)
    bool bSetNewMovementMode;                                                         // 0x0139 (size: 0x1)
    TEnumAsByte<EMovementMode> NewMovementMode;                                       // 0x013A (size: 0x1)
    bool bRestrictSpeedToExpected;                                                    // 0x013B (size: 0x1)
    class UCurveVector* PathOffsetCurve;                                              // 0x0140 (size: 0x8)
    class UCurveFloat* TimeMappingCurve;                                              // 0x0148 (size: 0x8)
    class UCurveFloat* TargetLerpSpeedHorizontalCurve;                                // 0x0150 (size: 0x8)
    class UCurveFloat* TargetLerpSpeedVerticalCurve;                                  // 0x0158 (size: 0x8)
...
class UAbilityTask_PlayMontageAndWait : public UAbilityTask
{
    ...
    bool bAllowInterruptAfterBlendOut;                                                // 0x0105 (size: 0x1)
...
class UGameplayAbility : public UObject
{
    ...
    FGameplayAbilityActivationInfo CurrentActivationInfo;                             // 0x00D8 (size: 0x20)
    FGameplayEventData CurrentEventData;                                              // 0x00F8 (size: 0xB0)
    TEnumAsByte<EGameplayAbilityNetExecutionPolicy::Type> NetExecutionPolicy;         // 0x01A8 (size: 0x1)
    TEnumAsByte<EGameplayAbilityNetSecurityPolicy::Type> NetSecurityPolicy;           // 0x01A9 (size: 0x1)
    TSubclassOf<class UGameplayEffect> CostGameplayEffectClass;                       // 0x01B0 (size: 0x8)
    TArray<FAbilityTriggerData> AbilityTriggers;                                      // 0x01B8 (size: 0x10)
    TSubclassOf<class UGameplayEffect> CooldownGameplayEffectClass;                   // 0x01C8 (size: 0x8)
    FGameplayTagContainer CancelAbilitiesWithTag;                                     // 0x01D0 (size: 0x20)
    FGameplayTagContainer BlockAbilitiesWithTag;                                      // 0x01F0 (size: 0x20)
    FGameplayTagContainer ActivationOwnedTags;                                        // 0x0210 (size: 0x20)
    FGameplayTagContainer ActivationRequiredTags;                                     // 0x0230 (size: 0x20)
    FGameplayTagContainer ActivationBlockedTags;                                      // 0x0250 (size: 0x20)
    FGameplayTagContainer SourceRequiredTags;                                         // 0x0270 (size: 0x20)
    FGameplayTagContainer SourceBlockedTags;                                          // 0x0290 (size: 0x20)
    FGameplayTagContainer TargetRequiredTags;                                         // 0x02B0 (size: 0x20)
    FGameplayTagContainer TargetBlockedTags;                                          // 0x02D0 (size: 0x20)
    TArray<class UGameplayTask*> ActiveTasks;                                         // 0x0310 (size: 0x10)
    class UAnimMontage* CurrentMontage;                                               // 0x0330 (size: 0x8)
    bool bIsActive;                                                                   // 0x0398 (size: 0x1)
    bool bIsAbilityEnding;                                                            // 0x0399 (size: 0x1)
    bool bIsCancelable;                                                               // 0x039A (size: 0x1)
    bool bIsBlockingOtherAbilities;                                                   // 0x039B (size: 0x1)
    bool bMarkPendingKillOnAbilityEnd;                                                // 0x03B0 (size: 0x1)
...
{
    class UAnimMontage* MontageToPlay;                                                // 0x03B8 (size: 0x8)
    float PlayRate;                                                                   // 0x03C0 (size: 0x4)
    FName SectionName;                                                                // 0x03C4 (size: 0x8)
    TArray<class TSubclassOf<UGameplayEffect>> GameplayEffectClassesWhileAnimating;   // 0x03D0 (size: 0x10)
    TArray<class UGameplayEffect*> GameplayEffectsWhileAnimating;                     // 0x03E0 (size: 0x10)
...
{
    FMovieSceneGameplayCueKey Cue;                                                    // 0x0108 (size: 0x90)
...
{
    FMovieSceneGameplayCueChannel Channel;                                            // 0x0108 (size: 0xF8)
